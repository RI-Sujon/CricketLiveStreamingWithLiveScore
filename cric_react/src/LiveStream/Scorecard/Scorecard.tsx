...
export default function Scorecard(props: any) {
    ...
    const [thisOver, setThisOver] = React.useState(0);
        ...
        if(props.matchData.team1Uid===props.matchData.firstInnings.onBatting){
            for(let i=0; i<props.matchData.team2Players.length; i++){
                if(props.matchData.team2Players[i].name===bowlerName){
                    ...
                    return <div><b>{props.matchData.team2Players[i].bowling.wicket}-{props.matchData.team2Players[i].bowling.runConceded}</b><small>{" "}({props.matchData.team2Players[i].bowling.over + "." + props.matchData.team2Players[i].bowling.ballInAOver})</small></div>
                }
            }
        }
        else{
    ...
    const thisOverFuntion = () => {
        var totalRun = [] as any;
        console.log(props.matchData.firstInnings.overs +":mmmmmmmmm222mm:"+ props.matchData.firstInningsOverTracking.length)
        for(var i=0; i<props.matchData.firstInningsOverTracking.length; i++){
            totalRun[i] = props.matchData.firstInningsOverTracking[i].totalRun;
        
            console.log(props.matchData.firstInnings.overs +":mmmmmmmmmmm:"+ props.matchData.firstInningsOverTracking[i].overNo)
            if(props.matchData.firstInnings.overs === props.matchData.firstInningsOverTracking[i].overNo){
                
                if(i===0){
                     setThisOver(totalRun[i]);
                }else{
                    
                    setThisOver(props.matchData.firstInnings.totalRun-totalRun[i]);
                }
            }
                ...
                <Grid item xs={4}>
                    <div className='scorecard_part'>
                        <table width={'100%'}> 
                            ...
                            <tr> 
                                <td>
                                    This Over: {thisOver!==0 ? thisOver : thisOver}
                                </td>
                            </tr>
                        </table>
                    </div>
...
//     const setBowlerRunAndBall = (bowlerName: any) => {
//         if(props.matchData.secondInnings.target === 0){
//             if(props.matchData.team1Uid===props.matchData.firstInnings.onBatting){
//                 for(let i=0; i<props.matchData.team2Players.length; i++){
//                     if(props.matchData.team2Players[i].name===bowlerName){
//                         return <div><b>{props.matchData.team2Players[i].batting.run}</b>({props.matchData.team2Players[i].batting.ball})</div>
