...
class TeamEditing extends StatefulWidget {
  const TeamEditing({Key? key}) : super(key: key);

  @override
  State<TeamEditing> createState() => _TeamEditingState();
}

class _TeamEditingState extends State<TeamEditing> {
