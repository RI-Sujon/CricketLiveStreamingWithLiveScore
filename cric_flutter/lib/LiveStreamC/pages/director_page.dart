...
// import 'package:cric_flutter/LiveStreamC/controllers/director_controller.dart';
...
//   Future<dynamic> showYoutubeBottomSheet(
//       BuildContext context, Object value, DirectorController directorNotifier) {
...
//   Future<dynamic> showTwitchBottomSheet(
//       BuildContext context, Object value, DirectorController directorNotifier) {
//     TextEditingController streamUrl = TextEditingController();
//     TextEditingController streamKey = TextEditingController();
//     return showModalBottomSheet(
...
//                                     context, value!, directorNotifier);
//                               } else {
...
//                           ),
//                           for (int i = 0;
//                               i < directorData.destinations.length;
//                               i++)
//                             PopupMenuButton(
//                               itemBuilder: (context) {
//                                 List<PopupMenuEntry<Object>> list = [];
...
//                                         title: Text("Remove Stream")),
//                                     value: 0));
//                                 return list;
//                               },
//                               child:
//                                   _deleteButton(directorData.destinations[i]),
//                               onCanceled: () {
//                                 print("You have canceled the menu");
//                               },
//                               onSelected: (value) {
//                                 directorNotifier.removePublishDestination(
//                                     directorData.destinations[i].url);
//                               },
//                               shape: RoundedRectangleBorder(
//                                   borderRadius: BorderRadius.circular(16)),
//                             ),
